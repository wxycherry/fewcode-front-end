        ...
        <el-form :inline="true" ref="menuSearchRef" :model="state.tableData.param" size="default">
          <el-row>
            ...
            <el-form-item label="菜单类型" class="ml10" prop="menuType">
              <el-select v-model="state.tableData.param.menuType" placeholder="请选择菜单类型" clearable style="width: 180px;">
                <el-option
            ...
            <el-form-item label="菜单状态" class="ml20" prop="status">
              <el-select v-model="state.tableData.param.status" placeholder="请选择菜单状态" clearable style="width: 180px;">
                <el-option
